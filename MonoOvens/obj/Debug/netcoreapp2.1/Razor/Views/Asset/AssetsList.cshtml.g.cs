#pragma checksum "E:\Mono\MonoOvens\Views\Asset\AssetsList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cf956f2c7411a15be53e2d86b07a3b78705d283b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cf956f2c7411a15be53e2d86b07a3b78705d283b", @"/Views/Asset/AssetsList.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6a142a725cb44017ac039f9523a2fc7f", async() => {
...
#line 40 "E:\Mono\MonoOvens\Views\Asset\AssetsList.cshtml"
          ...
          $(document).ready(function () {
                ...
                ""columnDefs"": [
                    ...
                    },
                    {
                        ""render"": function (data, type, row) {
                            return '<a href=""/Asset/EditAsset/' + data.id +'""  >Edit</a> <a href=""/Asset/AssetDetails/'+ data.id +'"" >Details</a>  <a id=""'+data.id+'"" onclick=""deleteSelectedItem(' + data.id + ')"">delete</a>'
                            //return '<a class=""btn btn-primary btn-link"" id=""' + data.id + '"" data-toggle=""tooltrip"" title="""" data-original-title=""Edit Detail"" onclick=""EditAssetbyAdmin(`' + data.id + '`)"">Edit</a> | <a class=""btn btn-dan");
                WriteLiteral(@"ger btn-link""   id = ""' + data.id + '"" data - toggle=""tooltip"" title = """" data - original - title=""View Detail"" onclick = ""deleteSelectedItem(' + data.id + ')"" > Delete</a > '
                        },
                        ""targets"": 20
                    }
                ],
            ...
            $('#assetsTable tbody').on('click', 'tr', function () {
                setTimeout(function () {
                    ...
                    // toggleActionButtons(selectedCount");
                WriteLiteral(" > 0);\r\n                }, 100)\r\n            });\r\n        });\r\n    </script>\r\n");
                EndContext();
            }
            );
