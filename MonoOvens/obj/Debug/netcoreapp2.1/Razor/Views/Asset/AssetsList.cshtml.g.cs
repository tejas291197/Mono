#pragma checksum "D:\tejas\MonoOvenProject\MonoOvens\Views\Asset\AssetsList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "75cfffaffb68ac1d7d8ad702a5aaf5ca8861901a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"75cfffaffb68ac1d7d8ad702a5aaf5ca8861901a", @"/Views/Asset/AssetsList.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "507d5f9af9504b7d895e8623c47789e0", async() => {
...
");
          ...
          $(document).ready(function () {
            //toggleActionButtons(false);
             ...
             assetsTable = $('#assetsTable').DataTable({
                ...
                //""order"": [[3, ""desc""]],
                ""ordering"": true, searching: true,                                   // make ordering fa");
                WriteLiteral(@"lse to getting the last out put as first.
 ...
 // return '<a href=""/Asset/EditAsset/' + data.id +'""  >Edit</a> <a href=""/Asset/AssetDetails/'+ data.id +'"" >Details</a>  <a id=""'+data.id+'"" onclick=""deleteSelectedItem(' + data.id + ')"">delete</a>'
     return '<a class=""btn btn-primary btn-link""   id=""' + data.id + '"" data-toggle=""tooltip"" title="""" data-original-title=""Edit Detail"" onclick=""EditAssetbyAdmin(`' + data.id + '`)"">edit</a> | <a class=""btn btn-danger btn-link""   id=""' + data.id + '"" data-toggle=""");
                WriteLiteral(@"tooltip"" title="""" data-original-title=""View Detail"" onclick=""deleteSelectedItem(' + data.id + ')"">delete</a>'
                        },
                        ""targets"": 20
                    }
                ],
