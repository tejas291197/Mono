#pragma checksum "E:\Mono\MonoOvens\Views\ControllerModules\ControllersList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "61bff23d31641cfadc62547ce0867388ef0793ab"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"61bff23d31641cfadc62547ce0867388ef0793ab", @"/Views/ControllerModules/ControllersList.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "33434f4642d143d585cdd068f477de62", async() => {
...
#line 22 "E:\Mono\MonoOvens\Views\ControllerModules\ControllersList.cshtml"
           Write(Html.DisplayNameFor(model => model.SerialNumber));

#line default
#line hidden
            EndContext();
            BeginContext(518, 1481, true);
            WriteLiteral(@"
            </th>
...
");
        ...
        function deleteSelectedItem(id) {
          ...
          $(document).ready(function () {
            //toggleActionButtons(false);
                ...
                //""order"": [[3, ""desc""]],
                ""ordering"": true, searching: true,                                   // make ordering false to getting th");
                WriteLiteral(@"e last out put as first.
  ...
  //return '<a href=""/Clients/EditClient/' + data.id +'""  >Edit</a> <a href=""/Clients/ClientDetails/'+ data.id +'"" >Details</a>  <a id=""'+data.id+'"" onclick=""deleteSelectedItem(' + data.id + ')"">delete</a>'
    return '<a class=""btn btn-primary btn-link""   id=""' + data.id + '"" data-toggle=""tooltip"" title="""" data-original-title=""Edit Detail"" onclick=""EditControllerbyAdmin(`' + data.id + '`)"">Edit</a> | <a class=""btn btn-danger btn-link""   id=""' + data.id + '"" data-tog");
                WriteLiteral(@"gle=""tooltip"" title="""" data-original-title=""View Detail"" onclick=""deleteSelectedItem(' + data.id + ')"">Delete</a>'
                        },
                        ""targets"": 23
                    }
                ],
                    ""columns"": [
                        ...
                        { ""data"": ""sleepDelay"" },
                        {
                            ...
                            {
               ");
                WriteLiteral(@"                 var date = new Date(row.controllerDate);
...
//                ""sAjaxSource"": '/ControllerModules/");
                WriteLiteral(@"ControllerAjaxDataProvider',
//                    ""sAjaxSource"": '/ControllerModules/ControllerAjaxData',  
//             //controllersTable = $('#controllersTable').DataTable({
//             //   select: {
//             //       style: 'single'
...
//                             var month = (date.getMonth()+1).toString();
//                             var day = date.getDate().toString();
//                             return (day.length > 1 ? day : ""0"" + d");
                WriteLiteral(@"ay) + ""/"" + (month.length > 1 ? month : ""0"" + month )+ ""/"" + date.getFullYear()
//                         }
//                     },
//                      {
//                        ""data"": ""status"",
...
//                             if (row.remoteKill == 1) {
//                                  return '<span style=""color:green""> Enab");
                WriteLiteral(@"led </span>'
//                             }
